...
function App() {
      ...
      <div className="flex justify-between items-center px-5 h-20">
        <div className="flex items-center">
          ...
          <div className="flex space-x-14 mr-6">
            <a href="#about" className="hover:text-gray-500 text-2xl transition">회사소개</a>
            <a href="#employment" className="hover:text-  gray-500 text-2xl transition">채용</a>
            <a href="#news" className="hover:text-gray-500 text-2xl transition">소식</a>
            <a href="#product" className="hover:text-gray-500 text-2xl transition">상품</a>
          </div>
      </div>
    </nav>
  ...
  <main className="bg-white text-black">
    ...
    <section id="문의하기" className="h-screen flex items-center justify-center bg-black">
      <h2 className="text-4xl font-bold text-white">문의하기</h2>
        {/* 문의하기 섹션 내용 추가 */}
    </section>
  </main>
</div>
